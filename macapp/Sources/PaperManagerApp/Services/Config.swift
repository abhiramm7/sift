...
/// Mirrors the on-disk layout from the existing Python project.
/// iCloud root defaults to ~/Library/Mobile Documents/com~apple~CloudDocs/PaperManager,
/// matching what `paper init` creates.
struct AppConfig {
    var iCloudRoot: URL
    ...
    static let storedRootKey = "PaperManager.iCloudRoot"
    static let onboardingDoneKey = "PaperManager.onboardingDone"
